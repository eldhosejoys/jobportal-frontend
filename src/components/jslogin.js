                            ...
                            <div class="my-5 text-xl-start ">
                                <div class="card shadow jlogin2" >
                                    <div class="card-body p-5 ">
                                        <h1 class="card-title text-center pb-4 h3 "><span class="jlogin3">JobSeeker Login</span> </h1>
                                        ...
                                        <div class="mt-3 text-center"><Link to="/jsregister">Register for an account</Link> 👉</div>
                                        </span><br/>
                                    </div>
                                </div>
                            </div>
